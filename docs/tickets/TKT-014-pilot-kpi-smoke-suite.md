...
- ARCH-001@0.1.0 §1.1 Trace matrix
- ARCH-001@0.1.0 §4 Data Flow
- ARCH-001@0.1.0 §8.3 KPI Measurement
- ARCH-001@0.1.0 §12 Risks & Open Questions
- ADR-005@0.1.0
- ADR-009@0.1.0
- `src/shared/types.ts`
...
- [ ] Tests prove K1-K7 helpers calculate the ARCH-001@0.1.0 §8.3 KPI values from synthetic data.
