...
- Add backup, rollback, and VPS migration helper scripts matching ARCH-001@0.1.0 §10.
...
- [ ] Tests prove `.env.example` contains every required variable from ARCH-001@0.1.0 §9.1 and contains no plausible secret values.
...
- [ ] Scripts include backup, rollback, and VPS migration command sequences from ARCH-001@0.1.0 §10.
