...
- ARCH-001@0.1.0 §3.2 C2 Onboarding and Target Calculator
- ARCH-001@0.1.0 §4.1 Onboarding and target creation
- ARCH-001@0.1.0 §5 `users`, `user_profiles`, `user_targets`, `summary_schedules`, `onboarding_states`
- ARCH-001@0.1.0 §9.1 Secrets Management
- ADR-005@0.1.0
- `src/shared/types.ts`
